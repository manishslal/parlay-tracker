...
def reproduce_live_team_issue():
    with app.app_context():
        print("Creating test bet with 'Live' team name...")
        ...
        # Leg with 'Live' as home team
        leg = BetLeg(
            bet_id=bet.id,
            player_name='LeBron James',
            player_team='Lakers',
            home_team='Live', # The issue reported
            away_team='TBD',
            game_date=today,
            sport='NBA',
