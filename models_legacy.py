...
class Bet(db.Model):
    ...
    secondary_bettors_test = db.Column(db.Text, default='[]')
    watchers_test = db.Column(db.Text, default='[]')
    
    # Bet identification (nullable because some old bets don't have IDs)
    betting_site_id = db.Column(db.String(100), nullable=True, index=True)
    ...
    def to_dict_structured(self, use_live_data=False):
        ...
        bet_dict = {
            ...
            'betting_site_id': self.betting_site_id or '',
